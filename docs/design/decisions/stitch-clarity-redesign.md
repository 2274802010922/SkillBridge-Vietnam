...
The shared visual layer is `frontend/styles/clarity.css`, imported after existing page
...
- `frontend/components/feedback/loading-ui.tsx` selects a dashboard, list, detail, review,
