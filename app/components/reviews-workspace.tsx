...
type ReviewRow = {
  ...
  challenge_brief: string; rubric_json: string; business_name: string; reviewer_organization_name: string; reviewer_organization_kind: "business" | "university"; review_mode: "self" | "independent";
